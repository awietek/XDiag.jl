...
function coo_matrixC(ops::OpSum, block::B, i0::Int64=1) where B <: Block
    blockr = B(cxx_block(ops.cxx_opsum, block.cxx_block))
    return coo_matrixC(ops, block, blockr, i0)
end
...
function coo_matrixC_32(ops::OpSum, block::B, i0::Int64=1) where B <: Block
    blockr = B(cxx_block(ops.cxx_opsum, block.cxx_block))
    return coo_matrixC_32(ops, block, blockr, i0)
end
...
function coo_matrixC(ops::OpSum, block_in::Block, block_out::Block, i0::Int64=1)
    nrows = size(block_out)
    ncols = size(block_in)
    if ((nrows == 0) || (ncols == 0))
...
function coo_matrixC_32(ops::OpSum, block_in::Block, block_out::Block, i0::Int64=1)
    nrows = size(block_out)
    ncols = size(block_in)
    if ((nrows == 0) || (ncols == 0))
