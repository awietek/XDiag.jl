...
constants(ops::OpSum) = Vector{String}(constants(ops.cxx_opsum))

# Utils
Base.isreal(ops::OpSum) = Bool(isreal(ops.cxx_opsum))
Base.isapprox(ops1::OpSum, ops2::OpSum, rtol::Float64=1e-12, atol::Float64=1e-12) = Bool(isapprox(ops1.cxx_opsum, ops2.cxx_opsum, rtol, atol))
