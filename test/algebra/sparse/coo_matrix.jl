...
@testset "coo_matrix" begin
    ...
    mr = matrix(ops, block)
    for i0 in [0, 1]
        sr64 = coo_matrix(ops, block; i0=i0)
        sr32 = coo_matrix_32(ops, block; i0=i0)
    ...
    mc = matrix(ops, block)
    for i0 in [0, 1]
        sc64 = coo_matrix(ops, block; i0=i0)
        sc32 = coo_matrix_32(ops, block; i0=i0)
